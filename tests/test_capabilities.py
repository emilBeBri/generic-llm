...
def test_image_capability_matrix():
    ...
    assert supports_image("deepseek", "deepseek-v4.1-flash")
...
def test_pdf_capability_matrix():
    ...
    assert not supports_pdf("deepseek", "deepseek-v4.1-flash")
...
def test_strict_schema_matrix():
    ...
    assert not supports_strict_schema("deepseek", "deepseek-v4.1-flash")
